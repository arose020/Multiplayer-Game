package com.rosenthal.retrogame.net.packets;
...
public class Packet02Move extends Packet {
	...
	public Packet02Move(String username, int x, int y, int numStepps, boolean isMoving, int movingDir) {
		super(02);
		this.username = username;
		this.x = x;
		this.y = y;
		this.numSteps = numStepps;
